...
/***/ "./src/components/endpoint/arg_editor.tsx":
/*!************************************************!*\
  !*** ./src/components/endpoint/arg_editor.tsx ***!
  \************************************************/
/*! no static exports found */
...
class ArgEditor extends React.Component {
    setValue(e) {
    ...
    renderEditor(type, suggested) {
        switch (type) {
            case "":
                return null;
            case "Suggested":
                return (React.createElement("select", { value: this.props.prop.arg_type_value, onChange: this.setValue.bind(this) },
                    React.createElement("option", { key: "", value: "" }),
                    suggested.map(s => (React.createElement("option", { key: s, value: s }, s)))));
            case "Parameter":
                return (React.createElement("select", { value: this.props.prop.arg_type_value, onChange: this.setValue.bind(this) },
                    React.createElement("option", { key: "", value: "" }),
                    Object.keys(this.props.stack.variables).map((v) => (React.createElement("option", { key: v, value: v },
                        v,
                        " -",
                        " ",
            ...
            default:
                return (React.createElement("b", null,
                    "Unknown arg type ",
                    JSON.stringify(this.props.prop)));
        }
    }
    static getSuggested(expected, stack) {
        if (!expected || !expected.Object)
            return [];
        let suggested = [];
    ...
    getArgType(suggested) {
        if (this.props.prop.arg_type == "Parameter" &&
    ...
    render() {
        ...
        if (this.props.expected) {
            text = (React.createElement(React.Fragment, null,
                ...
                "Expected ",
                getTypeName(this.props.expected)));
        }
        let suggested = ArgEditor.getSuggested(this.props.expected, this.props.stack);
        let type = this.getArgType(suggested);
        return (React.createElement(React.Fragment, null,
            React.createElement("select", { value: type, onChange: this.setPropType.bind(this) },
                React.createElement("option", { value: "" }),
                suggested.length ? (React.createElement("option", { value: "Suggested" }, "Suggested")) : null,
                React.createElement("option", { value: "Parameter" }, "Parameter"),
                React.createElement("option", { value: "String" }, "String")),
            this.renderEditor(type, suggested),
            text));
    }
}
exports.ArgEditor = ArgEditor;
...
/***/ "./src/components/endpoint/call_method.tsx":
/*!*************************************************!*\
  !*** ./src/components/endpoint/call_method.tsx ***!
  \*************************************************/
/*! no static exports found */
...
class CallMethod extends React.Component {
    ...
    renderArgument(arg, index) {
        let prop = this.props.instruction.arguments.find(a => a.name == arg.name) || {
            name: arg.name,
            arg_type: "String",
            arg_type_value: ""
        };
        return (React.createElement("tr", { key: arg.name },
            React.createElement("td", null,
                React.createElement("b", null, arg.name)),
            React.createElement("td", null,
    ...
    render() {
        ...
        let config_select = (React.createElement("select", { onChange: this.setConfig.bind(this), value: this.props.instruction.config },
            React.createElement("option", { value: "" }),
            this.props.configs.map(c => (React.createElement("option", { value: c.id, key: c.id }, c.name)))));
        if (!config) {
            return React.createElement("li", null, config_select);
        }
        let method = config.config.methods.find(m => m.name == this.props.instruction.method);
        let method_select = (React.createElement("select", { onChange: this.setMethod.bind(this), value: this.props.instruction.method },
            React.createElement("option", { value: "" }),
            config.config.methods.map(m => (React.createElement("option", { value: m.name, key: m.name }, m.name)))));
        if (!method) {
        ...
        return (React.createElement("li", null,
            ...
            React.createElement("table", null,
                React.createElement("tbody", null, method.input.map(this.renderArgument.bind(this)))),
            output));
    }
}
...
/***/ "./src/components/endpoint/instruction_base.tsx":
/*!******************************************************!*\
  !*** ./src/components/endpoint/instruction_base.tsx ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/components/endpoint/json_return.tsx":
/*!*************************************************!*\
  !*** ./src/components/endpoint/json_return.tsx ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/components/endpoint/overview.tsx":
/*!**********************************************!*\
  !*** ./src/components/endpoint/overview.tsx ***!
  \**********************************************/
/*! no static exports found */
...
const call_method_1 = __webpack_require__(/*! ./call_method */ "./src/components/endpoint/call_method.tsx");
const json_return_1 = __webpack_require__(/*! ./json_return */ "./src/components/endpoint/json_return.tsx");
const instruction_base_1 = __webpack_require__(/*! ./instruction_base */ "./src/components/endpoint/instruction_base.tsx");
const instruction_renderers = {
    CallMethod: call_method_1.CallMethod,
    JsonReturn: json_return_1.JsonReturn
};
class OverviewProps {
}
...
exports.OverviewState = OverviewState;
class Overview extends React.Component {
    ...
    changeInstruction(index, key, instruction) {
        this.setState(state => {
            let old_output_name = this.state.endpoint.instructions[index] &&
    ...
    componentInserted(original, index) {
        let endpoint = Object.assign({}, this.state.endpoint);
        let instruction_renderer = instruction_renderers[original.dataset.instruction];
        ...
        return (React.createElement("div", { className: "row" },
            React.createElement("div", { className: "col-md-8" },
                ...
                React.createElement("ul", { ref: this.drag_to }, this.state.endpoint.instructions.map((i, index) => {
                    ...
                    return (React.createElement(Renderer, { key: index, instruction: i[key], configs: this.props.configs, stack: stack, onDelete: this.deleteInstruction.bind(this, index), onChange: this.changeInstruction.bind(this, index, key) }));
                }))),
            React.createElement("div", { className: "col-md-4" },
                React.createElement("h4", null, "Drag and drop to add:"),
                React.createElement("ul", { ref: this.drag_from }, Object.keys(instruction_renderers).map(key => (React.createElement("li", { key: key, "data-instruction": key }, instruction_renderers[key].description())))))));
    }
}
...
class Dragger {
    ...
    move(ev) {
        ...
        if (!rectContainsHorizontal(this.to.getBoundingClientRect(), dragging_box)) {
            return true;
        }
        let before = null;
...
function rectContainsHorizontal(rect1, rect2) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const overview_1 = __webpack_require__(/*! ./endpoint/overview */ "./src/components/endpoint/overview.tsx");
class Root extends React.Component {
    constructor(props, context) {
        ...
        fetch("/api/endpoints")
            .then(r => r.json())
            .then((r) => {
            let active = r.endpoints.find((e) => "#" + e.name == document.location.hash) ||
                r.endpoints[0] ||
                null;
            this.setState({
